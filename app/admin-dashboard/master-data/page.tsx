          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {[
              ...
              <Link
                key={item.title}
                href={item.path}
                className="group p-6 bg-white dark:bg-[#0A1128]/40 rounded-3xl border-2 border-slate-100 dark:border-slate-800/50 hover:border-orange-500 dark:hover:border-orange-500 hover:shadow-[0_20px_40px_-15px_rgba(249,115,22,0.15)] transition-all hover:-translate-y-2 flex flex-col items-center text-center outline-none ring-offset-2 focus:ring-2 focus:ring-orange-500"
              >
                <div className="w-14 h-14 bg-slate-50 dark:bg-[#111827] rounded-2xl flex items-center justify-center text-2xl mb-4 shadow-sm group-hover:bg-orange-500 group-hover:scale-110 transition-all duration-300">
                  {item.icon}
                </div>
