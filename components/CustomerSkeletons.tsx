      ...
      <div className="bg-slate-50 dark:bg-[#0A1128] min-h-[calc(100vh-64px)] transition-colors">
        ...
        <div className="p-4 md:p-6 lg:p-10">
          <div className="max-w-6xl mx-auto">
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden min-h-[500px]">
              <div className="grid grid-cols-1 lg:grid-cols-2 h-full divide-y lg:divide-y-0 lg:divide-x divide-slate-100 dark:divide-slate-800">
                <div className="p-8 space-y-8">
                  ...
                  <div className="space-y-6 pt-2">
                    <div className="h-24 bg-slate-50 dark:bg-slate-800/50 rounded-2xl"></div>
                  </div>
                ...
                <div className="p-8 space-y-8">
                  <div className="space-y-4">
                    ...
                    <div className="h-20 bg-slate-50 dark:bg-slate-800/30 rounded-2xl"></div>
                  </div>
                  <div className="space-y-4">
                    <div className="h-3 w-24 bg-slate-200 dark:bg-slate-700 rounded"></div>
                    <div className="h-20 bg-slate-50 dark:bg-slate-800/30 rounded-2xl"></div>
                  ...
                  <div className="space-y-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                    ...
                    <div className="space-y-3">
                      {[1, 2, 3, 4].map((i) => (
                        <div key={i} className="flex justify-between h-4 bg-slate-50 dark:bg-slate-800/30 rounded"></div>
                      ))}
                    </div>
                  </div>
                </div>
